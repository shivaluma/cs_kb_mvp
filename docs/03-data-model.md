...
{
  "id": "uuid",
  "code": "SOP-ACCOUNT-VERIFICATION",
  "title": "Quy định xác minh thông tin tài khoản",
  "summary": "Hướng dẫn CS xác minh thông tin trước khi hỗ trợ các yêu cầu liên quan đến tài khoản.",
  "audience": ["customer", "driver"],
  "vertical": "account",
  "category": "verification",
  "tags": ["account_verification", "identity_check", "support_request"],
  "case_reasons": ["CR_ACCOUNT_VERIFICATION"],
  "status": "active",
