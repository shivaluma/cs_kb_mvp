...
const RELATION_TYPE_OPTIONS: Array<{ value: RelationType; label: string; help: string }> = [
  ...
  { value: "uses_tool", label: "uses_tool", help: "Rule hoặc action cần mở một công cụ/hệ thống làm việc." },
  { value: "has_action_template", label: "has_action_template", help: "Rule có mẫu thao tác copy-ready đi kèm." },
  { value: "has_case_reason", label: "has_case_reason", help: "Rule liên quan tới một case reason cụ thể." },
  ...
  { value: "child_of", label: "child_of", help: "Đơn vị này nằm dưới một collection/SOP cha." },
  { value: "parent_of", label: "parent_of", help: "Đơn vị này bao gồm các SOP/rule con." },
  { value: "modifies", label: "modifies", help: "SOP này cập nhật hoặc thay đổi một SOP/rule khác." },
